...
Action:=tcloseaction.caFree;
 ...
 procedure TForm20.rand(r,i:longint);
 begin
 if i=1 then   begin
...
procedure TForm20.FormKeyUp(Sender: TObject; var Key: Word; var KeyChar: Char;
  Shift: TShiftState);
begin
...
procedure Tform20.lines(bool,bol:boolean);
     begin
     if k=false then
       begin
...
procedure TForm20.Rectangle10Click(Sender: TObject);
begin
bool1:=true;
kakoy1:=4;
if k=false then
...
procedure TForm20.Rectangle3Click(Sender: TObject);
begin
bool2:=true;
kakoy2:=1;
if k=false then
...
procedure TForm20.Rectangle4Click(Sender: TObject);
begin
bool2:=true;
kakoy2:=2;
if k=false then
...
procedure TForm20.Rectangle5Click(Sender: TObject);
begin
bool2:=true;
kakoy2:=3;
if k=false then
...
procedure TForm20.Rectangle6Click(Sender: TObject);
begin
bool2:=true;
kakoy2:=4;
if k=false then
...
procedure TForm20.Rectangle7Click(Sender: TObject);
begin
bool1:=true;
kakoy1:=1;
                if k=false then
...
procedure TForm20.Rectangle8Click(Sender: TObject);
begin
bool1:=true;
kakoy1:=2;
if k=false then
...
procedure TForm20.Rectangle9Click(Sender: TObject);
begin
bool1:=true;
kakoy1:=3;
if k=false then
