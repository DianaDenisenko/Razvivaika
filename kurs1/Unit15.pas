...
var
  Form15: TForm15; s,s1 : integer; bool1,bool2,bool3,bool4,bool5,bool6,bool7,bool8,bool9,bool10,bool11 : boolean;
...
bool3:=true; button2.ImageIndex:=1;
bool2:=false;
   end
else
begin
...
procedure TForm15.FormKeyUp(Sender: TObject; var Key: Word; var KeyChar: Char;
  Shift: TShiftState);
begin
...
procedure TForm15.Rectangle4MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
 s:=0;
timer1.enabled:=true;
