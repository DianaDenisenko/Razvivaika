...
begin
  ...
  if (line7.Visible=true) and (line14.Visible=true) and (line9.Visible=true) and (line12.Visible=true) then
      begin Application.CreateForm(TForm26, Form26);
...
Action:=tcloseaction.caFree;
     ...
     procedure TForm27.rand(r,i:longint);
 begin
 if i=1 then   begin
...
procedure TForm27.FormKeyUp(Sender: TObject; var Key: Word; var KeyChar: Char;
  Shift: TShiftState);
begin
...
procedure Tform27.lines(bool,bol:boolean);
     begin
     if k=false then
       begin
...
procedure TForm27.Rectangle10Click(Sender: TObject);
begin
bool1:=true;
kakoy1:=4;
if k=false then
...
procedure TForm27.Rectangle3Click(Sender: TObject);
begin
bool2:=true;
kakoy2:=1;
if k=false then
...
procedure TForm27.Rectangle4Click(Sender: TObject);
begin
bool2:=true;
kakoy2:=2;
if k=false then
...
procedure TForm27.Rectangle5Click(Sender: TObject);
begin
bool2:=true;
kakoy2:=3;
if k=false then
...
procedure TForm27.Rectangle6Click(Sender: TObject);
begin
bool2:=true;
kakoy2:=4;
if k=false then
...
procedure TForm27.Rectangle7Click(Sender: TObject);
begin
bool1:=true;
kakoy1:=1;
                  if k=false then
...
procedure TForm27.Rectangle8Click(Sender: TObject);
begin
bool1:=true;
kakoy1:=2;
if k=false then
...
procedure TForm27.Rectangle9Click(Sender: TObject);
begin
bool1:=true;
kakoy1:=3;
if k=false then
