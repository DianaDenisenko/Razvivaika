...
procedure TForm30.FormKeyUp(Sender: TObject; var Key: Word; var KeyChar: Char;
  Shift: TShiftState);
begin
...
procedure TForm30.rand(r,i:longint);
 begin
 if k=false then
         begin
 if i=1 then   begin
...
procedure TForm30.lines(bool,bol:boolean);
     begin
     if k=false then
            begin
...
procedure TForm30.Rectangle10Click(Sender: TObject);
begin
bool1:=true;
kakoy1:=4;
if k=false then
...
procedure TForm30.Rectangle3Click(Sender: TObject);
begin
bool2:=true;
kakoy2:=1;
if k=false then
...
procedure TForm30.Rectangle4Click(Sender: TObject);
begin
bool2:=true;
kakoy2:=2;
if k=false then
...
procedure TForm30.Rectangle5Click(Sender: TObject);
begin
bool2:=true;
kakoy2:=3;
if k=false then
...
procedure TForm30.Rectangle6Click(Sender: TObject);
begin
bool2:=true;
kakoy2:=4;
if k=false then
...
procedure TForm30.Rectangle7Click(Sender: TObject);
begin
bool1:=true;
kakoy1:=1;
              if k=false then
...
procedure TForm30.Rectangle8Click(Sender: TObject);
begin
bool1:=true;
kakoy1:=2;
if k=false then
...
procedure TForm30.Rectangle9Click(Sender: TObject);
begin
bool1:=true;
kakoy1:=3;
if k=false then
