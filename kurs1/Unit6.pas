...
var
  Form6: TForm6; bool1,bool2,bool3,bool4,bool5,bool6 : boolean; xx1,yy1 : Single; s:integer;
...
procedure TForm6.Rectangle2MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
...
procedure TForm6.Rectangle2MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Single);
begin
...
procedure TForm6.Rectangle2MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
   bool5:=false;
    bool4:=false;
...
procedure TForm6.ПроверитьClick(Sender: TObject);
begin
