...
var
  Form10: TForm10;  bool1,bool2,bool3,bool4,bool5, bool6 : boolean; xx1,yy1 : Single; s:integer;

implementation

{$R *.fmx}

uses Unit3, Unit2, Unit11;
...
procedure TForm10.FormKeyUp(Sender: TObject; var Key: Word; var KeyChar: Char;
  Shift: TShiftState);
begin
...
procedure TForm10.Rectangle2MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Single);
begin
...
procedure TForm10.Rectangle2MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
     bool5:=false;
    bool4:=false;
...
s:=s+1;
 ...
 if s=1 then
  begin
  rectangle27.Visible:=true;   Application.CreateForm(TForm11, Form11);
...
procedure TForm10.ПроверитьClick(Sender: TObject);
begin
