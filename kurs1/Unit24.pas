...
{$R *.fmx}
  uses Unit3,Unit21, Unit31;   var k,bool1, bool2 : boolean; s,r,kakoy1,kakoy2: integer;
                                     a : array [1..16] of single;
   procedure TForm24.Button2Click(Sender: TObject);
begin
 if (line16.Visible=true) and (line4.Visible=true) and (line9.Visible=true) and (line12.Visible=true) then
   begin
   k:=true;
...
begin
 ...
 bool2:=false;
  ...
  a[4]:=rectangle10.Position.X;         //1 c 8, 2 c 5, 3 c 7,4 c 6
...
procedure TForm24.FormKeyUp(Sender: TObject; var Key: Word; var KeyChar: Char;
  Shift: TShiftState);
begin
...
procedure TForm24.rand(r,i:longint);
 begin
 if k=false then
         begin
 if i=1 then   begin
  ...
  case r of
  1 : begin rectangle6.Position.X:=a[8]; rectangle6.Position.Y:=a[16]; end;
  ...
  case r of
  1 : begin rectangle3.Position.X:=a[8]; rectangle3.Position.Y:=a[16]; end;
  ...
  case r of
  1 : begin rectangle5.Position.X:=a[8]; rectangle5.Position.Y:=a[16]; end;
  ...
  case r of
  1 : begin rectangle4.Position.X:=a[8]; rectangle4.Position.Y:=a[16]; end;
...
procedure Tform24.lines(bool,bol:boolean);
     begin
     if k=false then
            begin
...
procedure TForm24.Rectangle10Click(Sender: TObject);
begin
bool1:=true;
kakoy1:=4;
if k=false then
...
procedure TForm24.Rectangle3Click(Sender: TObject);
begin
bool2:=true;
kakoy2:=1;
if k=false then
...
procedure TForm24.Rectangle4Click(Sender: TObject);
begin
bool2:=true;
kakoy2:=2;
if k=false then
...
procedure TForm24.Rectangle5Click(Sender: TObject);
begin
bool2:=true;
kakoy2:=3;
if k=false then
...
procedure TForm24.Rectangle6Click(Sender: TObject);
begin
bool2:=true;
kakoy2:=4;
if k=false then
...
procedure TForm24.Rectangle7Click(Sender: TObject);
begin
bool1:=true;
kakoy1:=1;
              if k=false then
...
procedure TForm24.Rectangle8Click(Sender: TObject);
begin
bool1:=true;
kakoy1:=2;
if k=false then
...
procedure TForm24.Rectangle9Click(Sender: TObject);
begin
bool1:=true;
kakoy1:=3;
if k=false then
