...
var
  Form18: TForm18; s,s1 : integer; bool1,bool2,bool3,bool4,bool5,bool6,bool7,bool8,bool9,bool10,bool11 : boolean;

implementation

{$R *.fmx}
   uses unit3, Unit15, unit17, Unit19;
...
procedure TForm18.Button13Click(Sender: TObject);
begin
...
procedure TForm18.FormKeyUp(Sender: TObject; var Key: Word; var KeyChar: Char;
  Shift: TShiftState);
begin
...
procedure TForm18.Rectangle4MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
 s:=0;
timer1.enabled:=true;
