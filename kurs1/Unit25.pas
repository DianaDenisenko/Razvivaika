...
MediaPlayer1.FileName:='file:///storage/emulated/0/Download/audio/аист.mp3';
MediaPlayer1.Play;
 end
else  begin
...
begin
if (mediaplayer1.state=Tmediastate.stopped) or (mediaplayer1.state=Tmediastate.Unavailable) then  begin
MediaPlayer1.FileName:='file:///storage/emulated/0/Download/audio/котяра.mp3';
MediaPlayer1.Play;
 end
else  begin
Mediaplayer1.Stop; end;
...
begin
if (mediaplayer1.state=Tmediastate.stopped) or (mediaplayer1.state=Tmediastate.Unavailable) then  begin
MediaPlayer1.FileName:='file:///storage/emulated/0/Download/audio/павлин.mp3';
MediaPlayer1.Play;
 end
else  begin
Mediaplayer1.Stop; end;
...
begin
if (mediaplayer1.state=Tmediastate.stopped) or (mediaplayer1.state=Tmediastate.Unavailable) then  begin
MediaPlayer1.FileName:='file:///storage/emulated/0/Download/audio/петух.mp3';
MediaPlayer1.Play;
 end
else  begin
Mediaplayer1.Stop; end;
...
begin
 if (mediaplayer1.state=Tmediastate.stopped) or (mediaplayer1.state=Tmediastate.Unavailable) then  begin
MediaPlayer1.FileName:='file:///storage/emulated/0/Download/audio/белка.mp3';
MediaPlayer1.Play;
 end
else  begin
Mediaplayer1.Stop; end;
...
begin
if (mediaplayer1.state=Tmediastate.stopped) or (mediaplayer1.state=Tmediastate.Unavailable) then  begin
MediaPlayer1.FileName:='file:///storage/emulated/0/Download/audio/кукушка.mp3';
MediaPlayer1.Play;
 end
else  begin
Mediaplayer1.Stop; end;
...
begin
if (mediaplayer1.state=Tmediastate.stopped) or (mediaplayer1.state=Tmediastate.Unavailable) then  begin
MediaPlayer1.FileName:='file:///storage/emulated/0/Download/audio/лимон.mp3';
MediaPlayer1.Play;
 end
else  begin
Mediaplayer1.Stop; end;
...
begin
if (mediaplayer1.state=Tmediastate.stopped) or (mediaplayer1.state=Tmediastate.Unavailable) then  begin
MediaPlayer1.FileName:='file:///storage/emulated/0/Download/audio/медведь.mp3';
MediaPlayer1.Play;
 end
else  begin
Mediaplayer1.Stop; end;
...
begin
if (mediaplayer1.state=Tmediastate.stopped) or (mediaplayer1.state=Tmediastate.Unavailable) then  begin
MediaPlayer1.FileName:='file:///storage/emulated/0/Download/audio/шугадэди.mp3';
MediaPlayer1.Play;
 end
else  begin
Mediaplayer1.Stop; end;
...
begin
if (mediaplayer1.state=Tmediastate.stopped) or (mediaplayer1.state=Tmediastate.Unavailable) then  begin
MediaPlayer1.FileName:='file:///storage/emulated/0/Download/audio/цапля.mp3';
MediaPlayer1.Play;
 end
else  begin
Mediaplayer1.Stop; end;
...
begin
if (mediaplayer1.state=Tmediastate.stopped) or (mediaplayer1.state=Tmediastate.Unavailable) then  begin
MediaPlayer1.FileName:='file:///storage/emulated/0/Download/audio/репа.mp3';
MediaPlayer1.Play;
 end
else  begin
Mediaplayer1.Stop; end;
...
begin
if (mediaplayer1.state=Tmediastate.stopped) or (mediaplayer1.state=Tmediastate.Unavailable) then  begin
MediaPlayer1.FileName:='file:///storage/emulated/0/Download/audio/ёжик.mp3';
MediaPlayer1.Play;
 end
else  begin
Mediaplayer1.Stop; end;
...
begin
if (mediaplayer1.state=Tmediastate.stopped) or (mediaplayer1.state=Tmediastate.Unavailable) then  begin
MediaPlayer1.FileName:='file:///storage/emulated/0/Download/audio/крот.mp3';
MediaPlayer1.Play;
 end
else  begin
Mediaplayer1.Stop; end;
...
begin
if (mediaplayer1.state=Tmediastate.stopped) or (mediaplayer1.state=Tmediastate.Unavailable) then  begin
MediaPlayer1.FileName:='file:///storage/emulated/0/Download/audio/банан.mp3';
MediaPlayer1.Play;
 end
else  begin
Mediaplayer1.Stop; end;
...
begin
if (mediaplayer1.state=Tmediastate.stopped) or (mediaplayer1.state=Tmediastate.Unavailable) then  begin
MediaPlayer1.FileName:='file:///storage/emulated/0/Download/audio/капуста.mp3';
MediaPlayer1.Play;
 end
else  begin
Mediaplayer1.Stop; end;
...
begin
if (mediaplayer1.state=Tmediastate.stopped) or (mediaplayer1.state=Tmediastate.Unavailable) then  begin
MediaPlayer1.FileName:='file:///storage/emulated/0/Download/audio/жираф.mp3';
MediaPlayer1.Play;
 end
else  begin
Mediaplayer1.Stop; end;
...
begin
if (mediaplayer1.state=Tmediastate.stopped) or (mediaplayer1.state=Tmediastate.Unavailable) then  begin
MediaPlayer1.FileName:='file:///storage/emulated/0/Download/audio/зебра.mp3';
MediaPlayer1.Play;
 end
else  begin
Mediaplayer1.Stop; end;
...
begin
if (mediaplayer1.state=Tmediastate.stopped) or (mediaplayer1.state=Tmediastate.Unavailable) then  begin
MediaPlayer1.FileName:='file:///storage/emulated/0/Download/audio/дятел.mp3';
MediaPlayer1.Play;
 end
else  begin
Mediaplayer1.Stop; end;
...
begin
if (mediaplayer1.state=Tmediastate.stopped) or (mediaplayer1.state=Tmediastate.Unavailable) then  begin
MediaPlayer1.FileName:='file:///storage/emulated/0/Download/audio/заяц.mp3';
MediaPlayer1.Play;
 end
else  begin
Mediaplayer1.Stop; end;
...
begin
if (mediaplayer1.state=Tmediastate.stopped) or (mediaplayer1.state=Tmediastate.Unavailable) then  begin
MediaPlayer1.FileName:='file:///storage/emulated/0/Download/audio/арбуз.mp3';
MediaPlayer1.Play;
 end
else  begin
Mediaplayer1.Stop; end;
