...
var
  Form11: TForm11;  bool1,bool2,bool3,bool4,bool5, bool6 : boolean; xx1,yy1 : Single; s:integer;

implementation

{$R *.fmx}
   uses Unit3, Unit2, Unit12;
...
procedure TForm11.FormKeyUp(Sender: TObject; var Key: Word; var KeyChar: Char;
  Shift: TShiftState);
begin
...
procedure TForm11.Rectangle2MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
...
procedure TForm11.Rectangle2MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Single);
begin
...
procedure TForm11.Rectangle2MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
     bool5:=false;
    bool4:=false;
...
s:=s+1;
 ...
 if s=1 then
  begin
  Rectangle26.Visible:=true;  Application.CreateForm(TForm12, Form12);
...
procedure TForm11.ПроверитьClick(Sender: TObject);
begin
