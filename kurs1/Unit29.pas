...
{$R *.fmx}
   uses Unit3,Unit30;   var k,bool1, bool2 : boolean; s,r,kakoy1,kakoy2: integer;
...
begin
  ...
  if (line2.Visible=true) and (line4.Visible=true) and (line3.Visible=true) and (line6.Visible=true) then
   begin     Application.CreateForm(TForm30, Form30);      k:=true;
...
procedure TForm29.FormKeyUp(Sender: TObject; var Key: Word; var KeyChar: Char;
  Shift: TShiftState);
begin
...
procedure TForm29.rand(r,i:longint);
 begin
 if k=false then
   begin
 if i=1 then   begin
...
procedure TForm29.lines(bool,bol:boolean);
     begin
     if k=false then
              begin
...
procedure TForm29.Rectangle10Click(Sender: TObject);
begin
bool1:=true;
kakoy1:=4;
if k=false then
...
procedure TForm29.Rectangle3Click(Sender: TObject);
begin
bool2:=true;
kakoy2:=1;
if k=false then
...
procedure TForm29.Rectangle4Click(Sender: TObject);
begin
bool2:=true;
kakoy2:=2;
if k=false then
...
procedure TForm29.Rectangle5Click(Sender: TObject);
begin
bool2:=true;
kakoy2:=3;
if k=false then
...
procedure TForm29.Rectangle6Click(Sender: TObject);
begin
bool2:=true;
kakoy2:=4;
if k=false then
...
procedure TForm29.Rectangle7Click(Sender: TObject);
begin
bool1:=true;
kakoy1:=1;
              if k=false then
...
procedure TForm29.Rectangle8Click(Sender: TObject);
begin
bool1:=true;
kakoy1:=2;
if k=false then
...
procedure TForm29.Rectangle9Click(Sender: TObject);
begin
bool1:=true;
kakoy1:=3;
if k=false then
