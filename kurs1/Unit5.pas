...
uses
  ...
  FMX.Media, System.ImageList, FMX.ImgList, FMX.Controls.Presentation,
  FMX.StdCtrls;
...
var
  Form5: TForm5;  bool1,bool2,bool3,bool4,bool5,bool6,mp : boolean; xx1,yy1 : Single; s:integer;
...
procedure TForm5.Rectangle2MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
...
procedure TForm5.Rectangle2MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Single);
begin
...
procedure TForm5.Rectangle2MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
bool5:=false;
    bool4:=false;
...
procedure TForm5.ПроверитьClick(Sender: TObject);
begin
