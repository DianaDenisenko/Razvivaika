...
var
  Form7: TForm7;  bool1,bool2,bool3,bool4,bool5, bool6 : boolean; xx1,yy1 : Single; s:integer;
...
procedure TForm7.FormKeyUp(Sender: TObject; var Key: Word; var KeyChar: Char;
  Shift: TShiftState);
begin
...
procedure TForm7.Rectangle2MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
...
procedure TForm7.Rectangle2MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Single);
begin
...
procedure TForm7.Rectangle2MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
    bool5:=false;
    bool4:=false;
...
s:=s+1;
 ...
 if s=1 then
  begin
  rectangle26.Visible:=true; Application.CreateForm(TForm8, Form8);
...
procedure TForm7.ПроверитьClick(Sender: TObject);
begin
