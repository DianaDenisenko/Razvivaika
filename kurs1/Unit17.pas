...
uses
  ...
  FMX.Edit, FMX.Objects, FMX.Media;
...
{$R *.fmx}
   uses unit3, Unit15, unit16, Unit18;
     var   s,s1 : integer; bool1,bool2,bool3,bool4,bool5,bool6,bool7,bool8,bool9,bool10,bool11 : boolean;
...
procedure TForm17.Button11Click(Sender: TObject);
begin
if bool11=true then
          begin
           rectangle2.Visible:=false;
...
procedure TForm17.Button12Click(Sender: TObject);
begin
Form3.Show;
Form17.Close;
end;

procedure TForm17.Button13Click(Sender: TObject);
begin
if (mediaplayer1.state=Tmediastate.stopped) or (mediaplayer1.state=Tmediastate.Unavailable) then  begin
MediaPlayer1.FileName:='file:///storage/emulated/0/Download/audio/заданиелабиринт.mp3';
MediaPlayer1.Play;
 end
else  begin
...
procedure TForm17.FormKeyUp(Sender: TObject; var Key: Word; var KeyChar: Char;
  Shift: TShiftState);
begin
...
procedure TForm17.Rectangle4MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
 s:=0;
timer1.enabled:=true;
