...
var
  Form8: TForm8; bool1,bool2,bool3,bool4,bool5, bool6 : boolean; xx1,yy1 : Single; s:integer;

implementation

{$R *.fmx}

uses Unit3, Unit9,unit5;
...
procedure TForm8.FormKeyUp(Sender: TObject; var Key: Word; var KeyChar: Char;
  Shift: TShiftState);
begin
...
procedure TForm8.Rectangle2MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
...
procedure TForm8.Rectangle2MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Single);
begin
...
procedure TForm8.Rectangle2MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
          bool5:=false;
    bool4:=false;
...
s:=s+1;
 ...
 if s=1 then
  begin
  rectangle26.Visible:=true;  Application.CreateForm(TForm9, Form9);
...
procedure TForm8.ПроверитьClick(Sender: TObject);
begin
