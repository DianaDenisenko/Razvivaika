...
var
  Form14: TForm14;  bool1,bool2,bool3,bool4,bool5, bool6 : boolean; xx1,yy1 : Single; s:integer;

implementation

{$R *.fmx}
       Uses Unit2, Unit3, Unit31;
...
procedure TForm14.FormKeyUp(Sender: TObject; var Key: Word; var KeyChar: Char;
  Shift: TShiftState);
begin
...
procedure TForm14.Rectangle2MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
...
procedure TForm14.Rectangle2MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Single);
begin
...
procedure TForm14.Rectangle2MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
bool5:=false;
    bool4:=false;
...
begin
  Rectangle13.visible:=false;
Rectangle14.Visible:=true; form31.Show;
end;
if s=6 then
begin
  Rectangle14.Visible:=false;
...
procedure TForm14.ПроверитьClick(Sender: TObject);
begin
